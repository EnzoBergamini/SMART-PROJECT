            ...
            if filename.endswith(".txt"):
                ...
                with open(file_path, 'r') as file:
                    ...
                    for line_number, line in enumerate(lines, 1):
                        words = line.split()
                        assert len(words) == 5, f"File '{filename}', Line {line_number}: Expected 5 words, found {len(words)} words"
                    ...
                    for line_number, line in enumerate(lines, 1):
                        ...
                        if words:  
                            ...
                            try:
                                ...
                                assert False, f"File '{filename}', Line {line_number}: First word '{first_word}' is not an integer"
